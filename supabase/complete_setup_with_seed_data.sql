-- ============================================
-- UofT Flow - Complete Database Setup with Seed Data
-- Run this entire file in Supabase SQL Editor
-- ============================================

-- Drop existing tables if they exist (for clean re-install)
...
-- ============================================
-- 5. INSERT SEED FACILITIES (19 total)
-- ============================================
...
-- ============================================
-- 6. INSERT SEED REVIEWS (48 total)
-- ============================================
...
INSERT INTO public.reviews (id, facility_id, user_id, user_name, overall_rating, cleanliness_rating, condition, comment, created_at) VALUES
  ...
  -- Sidney Smith fountain (1 review)
  ...
  -- Additional reviews to reach 48 total
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'rls_auto_enable' AND pronamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')) THEN
...
-- SELECT * FROM public.facilities LIMIT 5;
