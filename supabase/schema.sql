...
-- This prevents unauthorized access to functions that run with elevated privileges

-- Fix for rls_auto_enable function (if it exists)
-- This function is auto-generated by Supabase and should not be callable by users
DO $$
BEGIN
  -- Revoke execute permissions from anon role
...
-- Additional security: Ensure handle_new_user is only callable by the trigger
-- Note: SECURITY DEFINER is required for triggers that cross schema boundaries
-- The function is protected by being in the public schema but only invoked by the trigger
REVOKE EXECUTE ON FUNCTION public.handle_new_user() FROM anon;
REVOKE EXECUTE ON FUNCTION public.handle_new_user() FROM authenticated;
-- Note: We don't revoke from public because the trigger needs to execute it
