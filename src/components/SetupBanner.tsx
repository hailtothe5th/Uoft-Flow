...
export default function SetupBanner() {
  return (
    <div className="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-accent p-4 mb-6 rounded-r-xl">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 mt-3 px-3 py-1.5 bg-uoft-blue dark:bg-slate-700 text-white rounded-lg text-xs font-semibold hover:bg-uoft-blue-light dark:hover:bg-slate-600 transition-colors"
          >
            Open SQL Editor
